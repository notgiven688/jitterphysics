...
namespace Jitter2D.Collision
{
    public class MPR
    {
        ...
        private static float SIMPLEX_EPSILON = 0.0000000001f;
             ...
             out JVector point, out JVector normal, out float penetration)
        {
            ...
            while (true)
            {
                ...
                if (JVector.Dot((v3 - v2), normal) <= SIMPLEX_EPSILON || ++maxIterations > 10)
                {
                    JVector ab = v2 - v1;
                    ...
                    else
                    {
                        ...
                        {
                            t /= denom;
                            normal.X = v1.X * t * ab.X;
                            normal.Y = v1.Y * t * ab.Y;
                        }
                    }
